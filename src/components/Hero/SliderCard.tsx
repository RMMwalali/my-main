  ...
  return (
    ...
    >
      <motion.img
        ...
        src={data.img}
        className=" absolute h-full w-full  rounded-2xl  object-cover brightness-75 grayscale"
      />
      <motion.div className=" absolute z-10 flex h-full items-end p-4">
        <motion.div>
          ...
          ></motion.div>
          <motion.p layoutId={data.location} className="text-xs font-display text-[#D5D5D6]">
            {data.location}
          </motion.p>
          <motion.h1
            layoutId={data.title}
            className="text-xl leading-6 font-display text-white"
          >
            {data.title}
          </motion.h1>
        </motion.div>
